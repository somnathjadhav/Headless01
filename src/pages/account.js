                      ...
                      {addresses.map((address) => (
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h3 className="text-base font-semibold text-gray-900" style={{fontSize: '16px'}}>
                        ...
                        <div className="space-y-2 mb-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <p className="font-medium text-gray-900" style={{fontSize: '14px'}}>{address.name}</p>
                          </div>
                          ...
                          {address.phone && (
                            <div className="flex items-center space-x-2">
                              ...
                              <p className="text-gray-600" style={{fontSize: '14px'}}>{address.phone}</p>
                            </div>
                          )}
                        </div>
