import { signupSchema, validateWithZod } from '../../../lib/zodSchemas';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const validation = validateWithZod(signupSchema, req.body);
    ...
    const { firstName, lastName, username, email, password, recaptchaToken } = validation.data;
